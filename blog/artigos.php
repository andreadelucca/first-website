...
<html>
    <head>
        ...
        <title>Todos os Artigos | Blog LUBNORTE</title>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div class="jumbotron">
                        <h1 class="display-3 text-white">Todos os Artigos</h1>
                        <hr class="m-y-md">
                    </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-8">
                            <?php
                            $materias = Read('postagem', "where tipopostagem = 'Artigo' and statuspost = 1 order by idpost desc");
                            if (!$materias) {
