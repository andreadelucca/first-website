...
<html>
    <head>
        ...
        <title>Todas as Notícias | Blog LUBNORTE</title>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div class="jumbotron">
                        <h1 class="display-3 text-white">Todas as Notícias</h1>
                        <hr class="m-y-md">
                    </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-8">
                            <?php
                            $materias = Read('postagem', "where tipopostagem = 'Noticia' and statuspost = 1 order by idpost desc");
                            if (!$materias) {
                                echo 'Nada a exibir. Volte aqui mais tarde para mais novidades';
                            } else {
                        ...
                        <div class="col-md-4">
                            <div class="col-md-12">
                                <aside class="col-md-12 blog-sidebar">
                                    ...
                                    <div class="p-3">
                                        <h4 class="font-italic">Nos siga em nossas redes sociais</h4>
