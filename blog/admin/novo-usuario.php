        ...
        <div class="container">
            ...
            if (isset($_POST['criar'])) {
                ...
                if (empty($form['nome'])) {
                    ...
                    $dbCheck = Read('usuarios', "WHERE usuario = '" . $form['usuario'] . "'");
                    if ($dbCheck) {
                        echo "
			<script>
			alert('Já existe um usuário com esse nome. Tente novamente.');
			location = 'novo-usuario.php';
			</script>
			";
                    } else {
                        if (Create('usuarios', $form)) {
                            echo "
				<script>
				alert('Usuário inserido no sistema com sucesso! Para barrar o acesso do usuário, desative-o em Gerenciar Usuários');
				location = 'index.php';
				</script>
				";
                        } else {
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nome que aparecerá como de usuário do Sistema ao logar" name="usuario">
                                </div>
                                <div class="form-group col-md-6 col-12">
                                    <label for="senha1">Senha</label>
                                    <input type="password" class="form-control" placeholder="Digite aqui a senha" name="senha">
                                </div>
                                <div class="form-group col-md-6 col-12">
                                    <label for="senha2">Repita a Senha</label>
                                    <input type="password" class="form-control" placeholder="Digite novamente a senha" name="senha2">
                                </div>
                                <div class="form-group col-12 text-center">
                                    <br>
                                    <input type="submit" name="criar" value="Criar Usuário" class="btn btn-primary">
